...
!!!warning
If the application _**does not**_ include any remote modules, use the [defineBuildConfig](https://workleap.github.io/wl-web-configs/webpack/configure-build/) function from [@workleap/webpack-configs](https://workleap.github.io/wl-web-configs/webpack/) instead of the `defineBuildHostConfig` function.
!!!
