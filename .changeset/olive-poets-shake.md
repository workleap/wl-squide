...
- A navigation section index entry orphaned by a failed registration is now cleared as well, instead of poisoning that menu and `$id` pair for the lifetime of the runtime.
