...
- [#698](https://github.com/workleap/wl-squide/pull/698) [`c92bdfc`](https://github.com/workleap/wl-squide/commit/c92bdfc17015fd524cb40eccc06c94c6cf69548e) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Plugins can now hook into the lifecycle of a deferred registration run, to clear and replay their own registry the way Squide clears and replays its navigation items.
...
- [#682](https://github.com/workleap/wl-squide/pull/682) [`b8bfd7c`](https://github.com/workleap/wl-squide/commit/b8bfd7caf4286c5cffbf449d2ea211ae49c5b8dc) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Fixed the module registries running their success logging on the error path. The `Successfully registered...` log sat after the `try/catch` rather than inside the `try`, so a module or deferred registration that failed had its failure logged and then, immediately after, a success written to the same logger scope.
...
- [#639](https://github.com/workleap/wl-squide/pull/639) [`9ad83bb`](https://github.com/workleap/wl-squide/commit/9ad83bb34e71d64e76b7f2a390f4da3ef2ebcf87) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Updated dependencies to their latest versions.
