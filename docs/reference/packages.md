...
| :icon-mark-github: [@squide/firefly-rsbuild-storybook](https://github.com/workleap/wl-squide/tree/main/packages/firefly-rsbuild-storybook) | Add support for [Storybook](https://storybook.js.org/) to the firefly technology stack. | [![npm version](https://img.shields.io/npm/v/@squide/firefly-rsbuild-storybook)](https://www.npmjs.com/package/@squide/firefly-rsbuild-storybook) |
