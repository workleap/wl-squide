...
export const i18NextInstanceKey = "remote-module";

// One chunk per language, only the active language is downloaded. For a remote module, the chunk is served by
// the remote through Module Federation.
