...
!!!warning
If the application _**does not**_ not include any remote modules, use the [defineDevConfig](https://workleap.github.io/wl-web-configs/webpack/configure-dev/) function from [@workleap/webpack-configs](https://workleap.github.io/wl-web-configs/webpack/) instead of the `defineDevHostConfig` function.
!!!
