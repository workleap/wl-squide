...
- [#706](https://github.com/workleap/wl-squide/pull/706) [`d37944e`](https://github.com/workleap/wl-squide/commit/d37944e0a82a459196ee08fb7bdea1bcf153d84c) Thanks [@patricklafrance](https://github.com/patricklafrance)! - The documented Storybook integration moved to `msw-storybook-addon` v3. Applications must update their `.storybook/preview.tsx` when they upgrade the addon — see the migration below.
