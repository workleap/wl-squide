...
!!!warning
If the application _**does not**_ not include any remote modules, use the [defineDevConfig](https://workleap.github.io/wl-web-configs/rsbuild/configure-dev/) function from [@workleap/rsbuild-configs](https://workleap.github.io/wl-web-configs/rsbuild/) instead of the `defineDevHostConfig` function.
!!!
