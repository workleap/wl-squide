...
!!!info
The examples in this guide bundle the resources of every supported language with the module. To download only the resources of the active language, refer to the [lazy-load the resources](../integrations/setup-i18next.md#lazy-load-the-resources) section of the [setup i18next](../integrations/setup-i18next.md) integration guide.
!!!
