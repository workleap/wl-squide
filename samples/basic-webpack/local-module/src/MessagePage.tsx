import { useToast } from "@basic-webpack/shared";
        ...
        <>
            ...
            <div style={{ backgroundColor: "#d3d3d3", color: "black", width: "fit-content" }}>
                ...
                <ul>
                    ...
                    <li>The navigation item for this page use custom metadata (<code>$meta</code>) to <code>highlight</code> the item in the navbar.</li>
