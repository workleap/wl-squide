...
| The start of a deferred registration run is exposed as `runtime.registerDeferredRegistrationScopeStartedListener(callback)`, fired for both the initial run and every update. Listener errors are logged, never propagated. | [0032](./0032-deferred-registration-scope-started-listener.md) |
