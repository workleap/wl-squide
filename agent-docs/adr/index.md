...
| Bootstrapping progresses through a deterministic state machine: `idle → registering → registered → ready`. Every readiness input is a one-way latch; nothing dispatches un-readiness. | [0009](./0009-bootstrapping-state-machine.md) |
