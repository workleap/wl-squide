...
- [#706](https://github.com/workleap/wl-squide/pull/706) [`d37944e`](https://github.com/workleap/wl-squide/commit/d37944e0a82a459196ee08fb7bdea1bcf153d84c) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Updated dependencies to their latest versions.
- Updated dependencies [[`d37944e`](https://github.com/workleap/wl-squide/commit/d37944e0a82a459196ee08fb7bdea1bcf153d84c)]:
  - @squide/core@7.5.1
...
- [#697](https://github.com/workleap/wl-squide/pull/697) [`a66a04a`](https://github.com/workleap/wl-squide/commit/a66a04afe75b6c570b0205902eb08cf028cba96c) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Added `runtime.registerDeferredRegistrationScopeStartedListener(callback)` and `runtime.removeDeferredRegistrationScopeStartedListener(callback)`, the non plugin counterpart of `Plugin.onDeferredRegistrationScopeStarted`.
...
- Updated dependencies [[`a66a04a`](https://github.com/workleap/wl-squide/commit/a66a04afe75b6c570b0205902eb08cf028cba96c)]:
  - @squide/core@7.5.0
  - @squide/react-router@10.2.0
...
- [#688](https://github.com/workleap/wl-squide/pull/688) [`cf88964`](https://github.com/workleap/wl-squide/commit/cf8896406ca59719b0343586569a842fcbc66112) Thanks [@patricklafrance](https://github.com/patricklafrance)! - `$priority` now orders navigation items at every depth, not only a menu's top-level items.

  **This is a breaking change.** A section's items were previously rendered in the order they appeared in its `children` array, whatever their `$priority`, and that was the documented contract: _"An item nested inside a section renders in the order it appears in that section's `children` array, and its `$priority` is ignored."_ They are now sorted the same way a menu's top-level items are.
...
- Updated dependencies [[`cf88964`](https://github.com/workleap/wl-squide/commit/cf8896406ca59719b0343586569a842fcbc66112)]:
  - @squide/react-router@10.0.0

## 18.7.0

### Minor Changes

- [#687](https://github.com/workleap/wl-squide/pull/687) [`b89b044`](https://github.com/workleap/wl-squide/commit/b89b044c5989ea4f16a8424a0886fdaf6181ce20) Thanks [@patricklafrance](https://github.com/patricklafrance)! - An item's `$priority` is now handed to the code rendering the menu, at every depth, and is declared on the item types themselves.
  ...
  ```tsx
  const renderLinkItem: RenderLinkItemFunction = (
    { label, linkProps, priority },
    key
  ) => {
    return (
...
- Updated dependencies [[`b89b044`](https://github.com/workleap/wl-squide/commit/b89b044c5989ea4f16a8424a0886fdaf6181ce20)]:
  - @squide/react-router@9.6.0

## 18.6.0

### Minor Changes

- [#689](https://github.com/workleap/wl-squide/pull/689) [`779bb3f`](https://github.com/workleap/wl-squide/commit/779bb3f05b6b711ebb88f2f49d470109e93aa34b) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Fixed a navigation section index collision that could put a nested item in the wrong menu.
...
- Updated dependencies [[`779bb3f`](https://github.com/workleap/wl-squide/commit/779bb3f05b6b711ebb88f2f49d470109e93aa34b)]:
  - @squide/react-router@9.5.0

## 18.5.0

### Minor Changes

- [#678](https://github.com/workleap/wl-squide/pull/678) [`4d65ac0`](https://github.com/workleap/wl-squide/commit/4d65ac00c3094d9276c7c9f5914499863701032b) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Reverts the registration reporting and navigation item correctness changes released in `@squide/firefly@18.4.0`, `@squide/react-router@9.3.0` and `@squide/core@7.2.0`.
  ...
  **The three fixes that release carried are withdrawn.** If you upgraded into `18.4.0` for one of them, it is going away again in this version. The changesets being undone are `brave-moons-argue`, `tidy-pandas-repeat` and `witty-carrots-jam`.
  ...
  - **The section index key returns to the `-` separator.** `menuId` and section `$id` are joined with `-` again, so `("analytics", "sidebar-performance")` and `("analytics-sidebar", "performance")` collide once more. A nested item can attach to the wrong menu's section, two distinct sections can throw `A navigation section index has already been registered for the menu`, and strict mode can report one missing section instead of two. The keys returned by `getPendingSectionIds` change content again — treat them as opaque. `parseSectionIndexKey` reverts to splitting on `-`, so it no longer round-trips a key back to its `menuId` and `sectionId`: a key built from ids that contain a `-` now yields more than two elements. It remains deprecated, and nothing in the framework calls it.
...
- Updated dependencies [[`4d65ac0`](https://github.com/workleap/wl-squide/commit/4d65ac00c3094d9276c7c9f5914499863701032b)]:
  - @squide/core@7.3.0
  - @squide/react-router@9.4.0
...
- Updated dependencies [[`fb2669e`](https://github.com/workleap/wl-squide/commit/fb2669e985e20d71363d50d6d703033afaf1c7a9), [`fb2669e`](https://github.com/workleap/wl-squide/commit/fb2669e985e20d71363d50d6d703033afaf1c7a9), [`fb2669e`](https://github.com/workleap/wl-squide/commit/fb2669e985e20d71363d50d6d703033afaf1c7a9)]:
  - @squide/react-router@9.3.0
  - @squide/core@7.2.0
...
- [#665](https://github.com/workleap/wl-squide/pull/665) [`7925636`](https://github.com/workleap/wl-squide/commit/7925636fb6c2c448279dca87262c7f72bd9500cb) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Added a `$meta` option to navigation items, separating metadata the rendering code reads from props it forwards.
...
- Updated dependencies [[`7925636`](https://github.com/workleap/wl-squide/commit/7925636fb6c2c448279dca87262c7f72bd9500cb)]:
  - @squide/react-router@9.1.0
...
- Updated dependencies [[`1fb3adb`](https://github.com/workleap/wl-squide/commit/1fb3adb99bd9573b6029852887f440deb88ca6f2)]:
...
- [#491](https://github.com/workleap/wl-squide/pull/491) [`9d150ae`](https://github.com/workleap/wl-squide/commit/9d150aea6530e54912333da3b3985fefac7c2487) Thanks [@claude](https://github.com/apps/claude)! - Updated dependencies to their latest versions.

- Updated dependencies [[`9d150ae`](https://github.com/workleap/wl-squide/commit/9d150aea6530e54912333da3b3985fefac7c2487)]:
  - @squide/env-vars@1.4.17
  - @squide/launch-darkly@1.0.8
  - @squide/msw@4.0.15
  - @squide/react-router@8.1.14
...
- Updated dependencies [[`cc3178b`](https://github.com/workleap/wl-squide/commit/cc3178b85212aba6570c42fb1bc7d552cc1fe998)]:
  - @squide/core@6.1.13
  - @squide/env-vars@1.4.16
  - @squide/launch-darkly@1.0.7
  - @squide/msw@4.0.14
  - @squide/react-router@8.1.13
...
- Updated dependencies [[`dbbead1`](https://github.com/workleap/wl-squide/commit/dbbead1573c115e553fabbe4fc8b61a9ff929d35)]:
...
- [#325](https://github.com/workleap/wl-squide/pull/325) [`779e392`](https://github.com/workleap/wl-squide/commit/779e392619e24e0d875c1d375f90b7e783f3a86d) Thanks [@patricklafrance](https://github.com/patricklafrance)! - Move `@workeap-telemetry/core` and `@workleap/logging` as a peerDependency of `@workleap/firefly`.
...
- Updated dependencies [[`e55c60b`](https://github.com/workleap/wl-squide/commit/e55c60b8e5a3c258a5a7d667ce990f73021f8e5d)]:
  - @squide/module-federation@6.5.0
  - @squide/react-router@7.3.0
  - @squide/core@5.7.0
  - @squide/msw@3.5.0
